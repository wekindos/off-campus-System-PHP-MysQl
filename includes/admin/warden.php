...
<div class="header">
            ...
            <div class="wrapper-cont">
                ...
                <br><div class="top-info">
                    <div class="right-info">
                        <a href="./admin_page.php">Home</a>/ <a href="./warden.php">warden</a>
                    </div>
                    <div class="user-info">
                        <div class="img">
        ...
        <div class="col-md-12">
            <div class="float-left">
                <h2>Warder Deatails</h2>

            </div>

            <div class="float-right">
                <a href="./add_user.php" class="btn btn-success">Add New Student</a>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                        include_once '../database.php';
                        $query ="SELECT * FROM users WHERE status='Warden' ";
                    ...
                    <?php if($result->num_rows>0):?>
                        <?php while($row= mysqli_fetch_row($result)): ?>
                            ...
                            <tr>
                                ...
                                <td> 
                                <a href="edit_user.php?id=<?php echo $row[0];?>" class="btn btn-primary">Edit</a>
                                <a href="delete_user.php?id=<?php echo $row[0];?>" class="btn btn-danger">Delete</a>
                            </tr>
