            ...
            <div class="wrapper-cont">
                ...
                <br><div class="top-info">
                    <div class="right-info">
                        <a href="./warden_page.php">Home</a>/ <a href="./off-campus-details.php">offcampusform</a>
                    </div>
                    <div class="user-info">
                        <div class="img">
            ...
            <table class="table infomap" >
                <thead>
                    <tr>
                        ...
                        <th scope="col">Local/Village</th>
                        <th scope="col">House Owner</th>
                        <th scope="col">House Owner No</th>
                ...
                <tbody>
                    <?php
                        include_once '../database.php';
                        $query ="SELECT * FROM offcampusform";
                    ...
                    <?php if($result->num_rows>0):?>
                        <?php while($row= mysqli_fetch_row($result)): ?>
                            ...
                            <tr>
                                ...
                                <a href="delete_user_details.php?id=<?php echo $row[0];?>" class="btn btn-danger">Delete</a>
                            </tr>
